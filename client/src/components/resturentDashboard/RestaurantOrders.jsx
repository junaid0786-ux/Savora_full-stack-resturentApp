...
const RestaurantOrders = () => {
  ...
  const updateStatus = async (orderId, newStatus) => {
    ...
    try {
      const { data } = await api.patch(`/order/update-status/${orderId}`, {
        status: newStatus,
      });
      if (data.success) {
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                #{newOrder._id.slice(-6).toUpperCase()} • ₹
        ...
        <div className="max-w-7xl mx-auto mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              Manage restaurant orders in real-time
            </p>
          </div>
                  ...
                  return (
                    ...
                    >
                      <td className="px-6 py-4">
                        <span className="block font-mono text-xs text-gray-400 mb-1">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-sm text-gray-900">
                              {order.customerID?.fullName || "Guest"}
                            </p>
                          ...
                          {order.status === "pending" ? (
                            <>
                              ...
                              <button
                                ...
                                className="px-4 py-2 rounded-lg bg-rose-600 text-white text-xs font-bold hover:bg-rose-700 shadow-md shadow-rose-200 transition-all hover:scale-105"
                              >
                                Accept Order
                              </button>
                            </>
            ...
            return (
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <span
                    className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-bold border ${config.bg} ${config.text} ${config.border}`}
                  >
